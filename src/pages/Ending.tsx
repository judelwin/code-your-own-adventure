...
// const floatingWords = [
//   // { text: 'print("goodbye world")', top: '10%', left: '20%' },
//   // { text: 'CS degree?', top: '15%', left: '70%' },
//   // { text: 'debugging life', top: '72%', left: '35%' },
//   // { text: 'grad school?', top: '45%', left: '20%' },
//   // { text: '01101100', top: '80%', left: '60%' },
// ]
...
const Ending = () => {
  ...
  const { academic, social, career, energy, joinedClubs } = state || {}
  ...
  const adviceBoard = [
    ...
    "Seek help early when classes get tough! Office hours with TAs and professors are extremely helpful!",
    "Enjoy the little wins. Every success is worth celebrating.",
    "Live in the moment!",
    "Remember that college is not just about getting a degree. It's about making friends, learning things that you are passionate about, and doing something that fulfills you!"
  ]
  ...
  return (
    ...
    >
      ...
      <div className=" p-[2px] rounded-xl backdrop-blur-md bg-gradient-to-r from-[#80C7F2] via-[#E4C1F9] to-[#FFB5B5] shadow-[0_0_18px_#FFE8D6] z-10 mb-6">
        <div className="bg-[#505050] rounded-xl p-6 grid grid-cols-2 gap-y-3 gap-x-6 font-jetbrains text-[#FFE8D6] text-[16px] text-left">
          <div>
